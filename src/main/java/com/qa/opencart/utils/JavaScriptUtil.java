...
public class JavaScriptUtil {
	...
	public void flash(WebElement ele) {
		...
		for(int i=0; i<10; i++) {
			changeColor("rgb(0,200,0)",ele);//1
			changeColor(bgcolor,ele);//2
		}
	}

	private void changeColor(String bgcolor, WebElement ele) {
	...
	public void generateConfirmPopup(String msg) {
		JavascriptExecutor js = (JavascriptExecutor)driver;
